...
for f in frac:
        ...
        new_y_train,fi=flip.furthest_first_label_flip(X, ytr_temp, f,GAMMA,C)
        ...
        #draw_contours(X, ytr, model, fi, 'SVM - random attack', 'random_attack')
        ...
        #draw_contours(X, ytr, model, fi, 'LID-SVM - furthest attack', 'lid_svm')
...
plt.title('flip(furthest) vs accuracy')
plt.legend()
plt.show()
