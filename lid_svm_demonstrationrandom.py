...
for f in frac:
        ...
        new_y_train=flip.flip_labels( ytr, f)
        ...
        #draw_contours(X, ytr, model, fi, 'LID-SVM - random attack', 'lid_svm')
...
plt.title('flip(random) vs accuracy')
plt.legend()
plt.show()
